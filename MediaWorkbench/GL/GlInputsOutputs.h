#ifndef MEDIAWORKBENCH_GLINPUTSOUTPUTS_H
#define MEDIAWORKBENCH_GLINPUTSOUTPUTS_H
...
namespace media
{
    class MEDIA_EXPORT GlInputsOutputs
    {
    public:
        GlInputsOutputs();
...
#endif // MEDIAWORKBENCH_GLINPUTSOUTPUTS_H
