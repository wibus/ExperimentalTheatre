...
#ifndef MEDIAWORKBENCH_GLFFMPEGCAMCORDER_H
#define MEDIAWORKBENCH_GLFFMPEGCAMCORDER_H
...
namespace media
{
    class MEDIA_EXPORT GLFFmpegCamcorder
    {
    public:
        GLFFmpegCamcorder();
        ~GLFFmpegCamcorder();
...
#endif // MEDIAWORKBENCH_GLFFMPEGCAMCORDER_H
