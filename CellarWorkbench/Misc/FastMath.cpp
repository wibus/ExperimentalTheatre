...
#error
    ...
    float fast_pow(float x, float y)
    {
        ...
        _mm_store_ss(&r, powf4(xs, ys));
        return r;
    }

    glm::vec2 fast_pow(const glm::vec2& x, const glm::vec2& y)
    {
        f4 rf4;
        f4 xf4 = {x.x, x.y, x.x, x.x};
        f4 yf4 = {y.x, y.y, y.x, y.x};
        rf4.m = powf4(xf4.m, yf4.m);
        return glm::dvec2(rf4.f[0], rf4.f[1]);
    }

    glm::vec3 fast_pow(const glm::vec3& x, const glm::vec3& y)
    {
        f4 rf4;
        f4 xf4 = {x.x, x.y, x.z, x.x};
        f4 yf4 = {y.x, y.y, y.z, y.x};
        rf4.m = powf4(xf4.m, yf4.m);
        return glm::dvec3(rf4.f[0], rf4.f[1], rf4.f[2]);
    }

    glm::vec4 fast_pow(const glm::vec4& x, const glm::vec4& y)
    {
        f4 rf4;
        f4 xf4 = {x.x, x.y, x.z, x.w};
        f4 yf4 = {y.x, y.y, y.z, y.w};
        rf4.m = powf4(xf4.m, yf4.m);
        return glm::dvec4(rf4.f[0], rf4.f[1], rf4.f[2], rf4.f[4]);
    }
}
